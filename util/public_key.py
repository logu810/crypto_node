...
class PublicKey:
    ...
    def to_dict(self):
        """Convert PublicKey to a dictionary."""
        return {
            'p0': str(self.p0),  # Assuming p0 is serializable or has __str__ method
            'p1': str(self.p1)   # Assuming p1 is serializable or has __str__ method
        }